...
public class PaymentConnection {
    ...
    public String findbyid(String id){
        ...
        String payment_connection(){
            return("Enter your bank account number: ");
        }

        String routing_connection(){
            return("Enter your routing number: ");
        }

        String complete(){
            return("Congratulation, your Wells Fargo Bank account has been linked to your account.\n" +
